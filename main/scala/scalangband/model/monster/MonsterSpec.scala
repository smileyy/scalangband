 ...
 */
class MonsterSpec(val name: String, val archetype: MonsterArchetype, val level: Int, val health: DiceRoll, val baseSpeed: Int = BaseEnergyUnit, val actions: Seq[Weighted[MonsterAction]], val inventory: MonsterInventoryGenerator) {
