...
abstract class Monster(name: String, var health: Int, energy: Int = Random.nextInt(BaseEnergyUnit - 1) + 1, var coordinates: Coordinates) extends Creature(name, energy) {
